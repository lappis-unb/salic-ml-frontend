  ...
  "function" == typeof define && define.amd
    ...
    ? (module.exports = e.document
        ...
        : function(e) {
            if (!e.document)
              throw new Error(
                "radialIndiactor requires a window with a document"
              );
  ...
  function u(t) {
    return function(e) {
      ...
      for (
        ...
        "#" == r[i] && ((a = i), (r[i] = n.shift()));
      return (
        r.splice(a + 1, r.lastIndexOf("#") - a, n.reverse().join("")),
        r.reverse().join("")
      );
    };
  }
        ...
        var n = "touchstart" == t.type ? "touchmove" : "mousemove",
          ...
          s = function(t) {
            ...
            var n = t.clientX || t.touches[0].clientX,
              ...
              a = (h + d + Math.atan2(i - u, n - l)) % (h + 0.0175),
  ...
  return (
    (l.prototype = {
      ...
      _init: function() {
        ...
        return (
          (this.formatter =
            "function" == typeof t.format ? t.format : u(t.format)),
          (this.maxLength = t.percentage
            ? 4
            : this.formatter(t.maxValue).length),
          f(n, n, e),
          this._drawBarBg(),
      ...
      _drawBarBg: function() {
        ...
        (e.strokeStyle = t.barBgColor),
          ...
          "transparent" != t.barBgColor &&
            (e.beginPath(),
            e.arc(r, r, t.radius - 1 + t.barWidth / 2, 0, 2 * Math.PI),
            e.stroke());
      },
      value: function(t) {
        ...
        if (
          ((e.strokeStyle = i),
          r.roundCorner && (e.lineCap = "round"),
          e.beginPath(),
          e.arc(s, s, r.radius - 1 + r.barWidth / 2, -d, (h * v) / 100 - d, !1),
          e.stroke(),
          r.displayNumber)
        ) {
          var B = e.font.split(" "),
            ...
            V =
              r.fontSize ||
              o /
                (this.maxLength - (Math.floor((1.4 * this.maxLength) / 4) - 1));
      ...
      animate: function(t) {
        var e = this.indOption,
          ...
          u =
            null != e.precision ? e.precision : Math.ceil(Math.log(a - i / o)),
          l = Math.pow(10, u),
          s = Math.round(((a - i) * l) / o) / l;
        t = i > t ? i : t > a ? a : t;
        var c = n > t;
        return (
          this.intvFunc && clearInterval(this.intvFunc),
          (this.intvFunc = setInterval(function() {
            if ((!c && n >= t) || (c && t >= n)) {
              if (r.current_value == n)
                return (
                  clearInterval(r.intvFunc),
                  void (
                    e.onAnimationComplete &&
                    e.onAnimationComplete(r.current_value)
                  )
                );
              n = t;
            }
      ...
      option: function(t, e) {
        return e === n
          ...
          : (-1 !=
              ...
              ((this.indOption[t] = e), this._init().value(this.current_value)),
            void (this.indOption[t] = e));
      }
    }),
    (s.defaults = {
      radius: 50,
    ...
    (e.radialIndicator = s),
    t &&
      (t.fn.radialIndicator = function(e) {
