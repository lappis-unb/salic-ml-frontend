...
function getItensOrcamentariosForaDoComum(){
    return {
        ...
        "helper_text": "Indica os itens orçamentários deste projeto que \
            <strong>não estão entre os mais comuns</strong> do segmento.\
            Também lista os itens que aparecem frequentemente em projetos do segmento, \ mas que <strong>não aparecem neste projeto</strong>.",
        "value": getRandomPercentage(),
        "value_text": getRandomPercentage() + "%",
        "value_is_valid": true, 
        "outlier_check": getRandomOutlier(),
        ...
        "expected_itens": getElementsList(),
        "missing_itens": getElementsList(),
...
function getComprovantesDePagamento(){
    return {
        ...
        "helper_text": "Compara a quantidade de comprovantes deste projeto com a \
...
function getPrecosAcimaDaMedia(){
    return {
        ...
        "helper_text": "<p>Verifica a quantidade de itens com valor acima da mediana histórica neste projeto e compara com a <strong>quantidade mais frequente</strong> de itens acima da mediana em projetos do mesmo segmento</p>",
        "value": getRandomPercentage(),
...
function getValorComprovado(){
    return {
        ...
        "helper_text": "<p>Compara o valor comprovado neste projeto com o <strong>valor mais frequentemente</strong> comprovado em projetos do mesmo segmento</p>",
        "value": getRandomPercentage(),
        "value_text": "R$ " + getRandomPercentage(),
        "value_is_valid": true, 
        "outlier_check": getRandomOutlier(),
...
function getValorCaptado(){
    return {
        ...
        "helper_text": "<p>Compara o valor captado neste projeto com o <strong>valor mais frequentemente</strong> captado em projetos do mesmo segmento</p>",
        "value": getRandomPercentage(),
        "value_text": "R$ " + getRandomPercentage(),
        "value_is_valid": true, 
        "outlier_check": getRandomOutlier(),
...
function getProjetosDoMesmoProponente(){
    return {
        ...
        "helper_text": "<p>Indica os projetos que o proponente já executou no passado.</p>",
        "value": getRandomPercentage(),
        "value_text": getRandomPercentage(),
        "value_is_valid": true, 
        "outlier_check": getRandomOutlier(),
...
function getValorAprovado(){
    return {
        ...
        "helper_text": "<p>Indica a proporção de fornecedores que <strong>nunca participaram de projetos</strong> de incentivo antes em relação ao total de fornecedores envolvidos com o projeto.</p> <p>Também lista os itens orçamentários dos novos fornecedores.</p>",
        "value": getRandomPercentage(),
        "value_text": "R$ " + getRandomPercentage(),
        "value_is_valid": true, 
        "outlier_check": getRandomOutlier(),
